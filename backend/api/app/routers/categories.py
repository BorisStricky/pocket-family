...
async def create_category(
    ...
    category_read = await category_service.build_category_read(db, category_record.id, active_context.active_tenant.id)
...
async def get_category(
    ...
    category_read = await category_service.build_category_read(db, category_id, active_context.active_tenant.id)
